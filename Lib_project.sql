...
CREATE TABLE book (
    ...
    description TEXT, -- 설명
	check_out_count INT DEFAULT 0, -- 총 대출량 (기본값 : 0)
...
=======
DROP TABLE book;
>>>>>>> 752a7675ebc12b4224e3113c506b97dd1e6772b8
...
VALUES 
    ...
    ('혼자 공부하는 컴퓨터 구조 + 운영체제', '강민철', '한빛미디어', 'images/4.jpg', 1, 254, '1:1 과외하듯 배우는 IT 지식 입문서. 독학으로 컴퓨터 구조와 운영체제를 배우는 입문자가 ‘꼭 필요한 내용을 제대로 학습’할 수 있도록 구성했다. 뭘 모르는지조차 모르는 입문자의 막연한 마음에 십분 공감하여 과외 선생님이 알려주듯 친절하게, 핵심 내용만 콕콕 집어 준다.'),
    ...
    ('브라질에 비가 내리면 스타벅스 주식을 사라', '피터 나바로', '에프엔미디어', 'images/18.jpg', 4, 245, '미국 중앙은행이 갑자기 기준금리를 올리면 왜 유럽과 아시아의 주식시장이 충격을 받을까? 석유수출국기구가 대규모 감산을 결정하면 중국과 한국의 물가와 에너지 섹터 주가에 어떤 영향을 미칠까? 이 책은 이 같은 거시경제 변수가 주식시장과 어떻게 연계되는지 설명하고, 이를 활용해 투자 성과를 높이고 리스크도 관리하는 구체적인 방법을 알려준다. 핵심 경제 지표와 활용법을 명쾌하게 정리한 ‘매크로(macro) 투자의 고전’으로 널리 알려진 책이다.'),
...
=======
    ('건강과 다이어트를 동시에 잡는 7대 3의 법칙 채소·과일식', '조승우', '바이북스', 'images/27.jpg', 6, 23, '한약사가 알려주는 채소·과일식 해독법. 다이어트 보좌관이자 피토테라피스트 한약사 조승우가 《건강과 다이어트를 동시에 잡는 채소·과일식》을 세상에 내놓는다. 다이어트의 핵심은 독소 청소인데, 이를 위해 단순하면서 자연스러운 가장 효과적인 식단인 채소·과일식을 소개한다. 이 책은 가공식품과 화학첨가제의 진실을 알려준다. 또한 채소·과일식을 손쉽게 할 수 있는 방법부터 3주 프로그램을 통해 식단관리하는 방법까지 담겨 있다. 저자는 채소·과일식을 70%, 가공식품을 30%로 식단관리를 하도록 권한다. 여러분의 건강하고 행복한 삶을 기원한다.'),
    ('오늘 이 계절을 사랑해!', '진민섭', '세미콜론', 'images/28.jpg', 6, 45, '최소한의 양념과 조리법으로 재료 본연의 맛은 살리고, 조리 시간은 줄이는 ‘후암동삼층집’만의 노하우가 가득하다. 자취 1인 가구부터 대가구까지 두루 적용하기에 무리가 없으며, 요리 초보라도 누구나 두려움 없이 부엌에 설 수 있도록 돕는다. 이 책은 주방 곁에 늘 두고 싶은 계절 안내서로서의 역할을 톡톡히 할 것이다. 지금이 아니면 느끼지 못할 자연의 생명력과 건강한 음식으로 일상을 채워간다는 즐거움과 뿌듯함을 지금 바로 느껴보자.'),
    ('안밥모 베스트 유아식', '이샘', '래디시', 'images/29.jpg', 6, 23, '아이가 유아식을 먹기 시작하면 한동안 먹지 않아 애간장을 녹이는 일명 ‘밥태기’의 시기가 꼭 찾아온다. ‘먹이기 전쟁’으로 지친 수많은 부모들, 심지어 육아 중인 유명 연예인들도 가입한다는 국내 최대 유아식 커뮤니티가 있다. 9만 회원의 열렬한 지지를 받으며 밥태기 극복의 아이콘으로 자리매김한 네이버 대표카페 ‘안밥모’의 인기 레시피가 책으로 출간되었다.'),
    ('매일 만들어 먹고 싶은 별미김밥 / 주먹밥 / 토핑유부초밥', '정민', '레시피팩토리', 'images/30.jpg', 6, 24, '집에 있는 재료만으로 휘리릭 만드는 초간단 주먹밥부터 소문난 맛집 메뉴를 변형한 별미 김밥, 트렌디한 맛과 비주얼의 토핑 유부초밥까지 한 권에 싹 모아 소개한 소장가치가 남다른 한입밥책이다.'),
>>>>>>> 752a7675ebc12b4224e3113c506b97dd1e6772b8
