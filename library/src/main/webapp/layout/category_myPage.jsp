...
<nav>
	...
	<table class="category_table" border="1">
		<tr>
			<td><a href="/library/myPage?menu=updateInfo" class="myPage_updateInfo" style="font-size: 17px;">회원 정보 수정</a></td>
		</tr>
		<tr>
			<td><a href="/library/myPage?menu=recordCheckout" class="myPage_recordCheckout" style="font-size: 17px;">내 서재</a></td>
		</tr>
		<tr>
